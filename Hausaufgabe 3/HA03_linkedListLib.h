...
/** 
    ...
    \param[in]  pointer to start element of current list        
*/
void loadElemList(listElement *, FILE *);

/** 
    \FUNCTION: loadElemList
 
    \AUTHOR: samara dominik

    \DATE: 2022-01-28

    \DESCRIPTION: loads each Element from chosen File into current List
 
    \param[in]  pointer to start element of current list, pointer to chosen File   
*/
